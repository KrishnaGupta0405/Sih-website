...
// export function ChartRadarGridCircleLeft(globalActivityLogs:ActivityLog) {
...
// // Function for the radar chart of modules completed
// export async function ChartRadarGridCircleLeft({ globalActivityLogs }: { globalActivityLogs: ActivityLog[] }) {
  
//   console.log("before")
//   // Ensure globalActivityLogs is an array (even if it's empty)
//   const chartDataModules = await transformActivityLogsModules(globalActivityLogs);
//   console.log("after")
//   // const chartDataModules = [
...
export const ChartRadarGridCircleLeft = ({ globalActivityLogs }: { globalActivityLogs: ActivityLog[] }) => {
  ...
  return (
    <Card>
      <CardHeader className="items-center pb-4">
        <CardTitle>Total Modules Completed</CardTitle>
        <CardDescription>Summary of modules completed recently.</CardDescription>
      </CardHeader>
      <CardContent className="pb-0">
        <ChartContainer
          config={chartConfig}
